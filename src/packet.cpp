...
namespace ObscuraProto {
    ...
    byte_vector Payload::serialize() const {
        ...
        buffer.insert(buffer.end(),
                      reinterpret_cast<const uint8_t*>(&be_op_code),
                      reinterpret_cast<const uint8_t*>(&be_op_code) + sizeof(be_op_code));
    ...
    PayloadBuilder& PayloadBuilder::add_param(const byte_vector& param) {
        ...
        payload_.parameters.insert(payload_.parameters.end(),
                                   reinterpret_cast<uint8_t*>(&be_len),
                                   reinterpret_cast<uint8_t*>(&be_len) + sizeof(be_len));
    ...
    PayloadBuilder& PayloadBuilder::add_param(int16_t param) {
        ...
        std::copy(reinterpret_cast<uint8_t*>(&be_param),
                  reinterpret_cast<uint8_t*>(&be_param) + sizeof(be_param),
                  vec.begin());
        return add_param(vec);
    }
