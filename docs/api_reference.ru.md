...
Устанавливает функцию обратного вызова, которая будет вызвана при получении валидного, расшифрованного `Payload` от любого клиента.
...
#### `void set_on_payload_callback(OnPayloadCallback callback)`
Устанавливает функцию обратного вызова, которая будет вызвана при получении валидного, расшифрованного `Payload` от сервера.
